  ...
  Real _filter(const int dx, const int dy, const int dz) const {
    const int s[3] = {
        !Block::shouldProcessDirectionY
            ? 0
            : bWaveletX ? Wavelets::GaSupport[0] : Wavelets::HaSupport[0],
        !Block::shouldProcessDirectionY
            ? 0
            : bWaveletY ? Wavelets::GaSupport[0] : Wavelets::HaSupport[0],
        !Block::shouldProcessDirectionZ
            ? 0
            : bWaveletZ ? Wavelets::GaSupport[0] : Wavelets::HaSupport[0]};

    const int e[3] = {
        !Block::shouldProcessDirectionX
            ? 1
            : bWaveletX ? Wavelets::GaSupport[1] : Wavelets::HaSupport[1],
        !Block::shouldProcessDirectionY
            ? 1
            : bWaveletY ? Wavelets::GaSupport[1] : Wavelets::HaSupport[1],
        !Block::shouldProcessDirectionZ
            ? 1
            : bWaveletZ ? Wavelets::GaSupport[1] : Wavelets::HaSupport[1]};
    ...
    for (int iz = 0; iz < nZ; iz++)
      for (int iy = 0; iy < nY; iy++)
        for (int ix = 0; ix < nX; ix++) {
          ...
          const int n = !Block::shouldProcessDirectionY
                            ? 2
                            : !Block::shouldProcessDirectionZ ? 4 : 8;
          for (int i = 0; i < n; i += 2) {
