      ...
      for (int iz = 0; iz < BlockType::sizeZ; iz++)
        for (int iy = 0; iy < BlockType::sizeY; iy++)
          for (int ix = 0; ix < BlockType::sizeX; ix++) {
            ...
            if (lab(ix, iy, iz).p_w + lab(ix, iy, iz).p_g +
                    lab(ix, iy, iz).phi >
                0.) {
              df_loc = lab(ix, iy, iz).p_w * Dw + lab(ix, iy, iz).p_g * Dg;
              df[0] =
                  lab(ix - 1, iy, iz).p_w * Dw + lab(ix - 1, iy, iz).p_g * Dg;
              df[1] =
                  lab(ix + 1, iy, iz).p_w * Dw + lab(ix + 1, iy, iz).p_g * Dg;
              df[2] =
                  lab(ix, iy - 1, iz).p_w * Dw + lab(ix, iy - 1, iz).p_g * Dg;
              df[3] =
                  lab(ix, iy + 1, iz).p_w * Dw + lab(ix, iy + 1, iz).p_g * Dg;
              df[4] =
                  lab(ix, iy, iz - 1).p_w * Dw + lab(ix, iy, iz - 1).p_g * Dg;
              df[5] =
                  lab(ix, iy, iz + 1).p_w * Dw + lab(ix, iy, iz + 1).p_g * Dg;
...
template <int nDim = 3> struct TimeUpdate {
  double dt;

  TimeUpdate(double dt_) { dt = dt_; }

  TimeUpdate(const TimeUpdate &, double dt_) { dt = dt_; }
      ...
      for (int iz = 0; iz < BlockType::sizeZ; iz++)
        for (int iy = 0; iy < BlockType::sizeY; iy++)
          for (int ix = 0; ix < BlockType::sizeX; ix++) {
            ...
            // reduce numerical roundings errors
            o(ix, iy, iz).phi =
                (o(ix, iy, iz).phi > 1.) ? 1. : o(ix, iy, iz).phi;
            o(ix, iy, iz).phi =
                (o(ix, iy, iz).phi < 0.) ? 0. : o(ix, iy, iz).phi;
            o(ix, iy, iz).wm = (o(ix, iy, iz).wm < 0.) ? 0. : o(ix, iy, iz).wm;
            o(ix, iy, iz).gm = (o(ix, iy, iz).gm < 0.) ? 0. : o(ix, iy, iz).gm;
            o(ix, iy, iz).csf =
                (o(ix, iy, iz).csf < 0.) ? 0. : o(ix, iy, iz).csf;
...
template <int nDim = 3> struct PressureTimeUpdate {
  double dt;

  PressureTimeUpdate(double dt_) { dt = dt_; }

  PressureTimeUpdate(const PressureTimeUpdate &, double dt_) { dt = dt_; }
